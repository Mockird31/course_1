...
files_pos="./func_tests/data/pos_??_in.txt"
files_neg="./func_tests/data/neg_??_in.txt"
regex="[0-9][0-9]"
...
for in_file in $files_pos; do
    ...
    args_file="./func_tests/data/pos_$number""_args.txt"
    out_file="./func_tests/data/pos_$number""_out.txt"

    pos_t="./func_tests/scripts/pos_case.sh ""$in_file ""$out_file ""$args_file"
...
for in_file in $files_neg; do
    ...
    args_file="./func_tests/data/neg_$number""_args.txt"
    neg_t="./func_tests/scripts/neg_case.sh ""$in_file ""$args_file"
